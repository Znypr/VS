...
public class LoggingClient {
	...
	public static void main(String[] args) {
		...
		if (args.length != 8) {
			throw new RuntimeException(
					"Es wurden nicht alle 8 benötigten Kommandozeilenparameter eingegeben. Bitte prüfen Sie Ihre Kommandozeilenparameter und ggf. die Dokumentation dieser Anwendung.");
		}

		String PRI = getPriorityValue(args[0], args[1]);
		...
		try (DatagramSocket socket = new DatagramSocket()) {
			...
			System.out.println(
					"IP vom Logging-Server gefunden: " + loggingServerIaddr.getHostAddress() + " . Sende Syslog-Nachricht...");
			...
			if (data.length > BUFSIZE) {
				throw new RuntimeException("Die Syslog Nachricht ist mit " + data.length + " Bytes zu lang! Maximal "
	...
	private static String getPriorityValue(String facility, String severity) {
